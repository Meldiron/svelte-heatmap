(function (global, factory) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(rect, "mouseout", /*mouseOut*/ ctx[7]),
    					listen(rect, "mouseover", /*mouseOver*/ ctx[8])
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("mouseEnter" in $$props) $$invalidate(10, mouseEnter = $$props.mouseEnter);
    		if ("mouseLeave" in $$props) $$invalidate(11, mouseLeave = $$props.mouseLeave);
    	};
