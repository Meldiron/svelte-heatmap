(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SvelteHeatmap = factory());
    ...
    /* src/views/Cell.svelte generated by Svelte v3.29.0 */

    function create_fragment(ctx) {
    	let path;
    	let path_data_date_value;
    	...
    	return {
    		c() {
    			...
    			attr(path, "data-date", path_data_date_value = stringifyDate(/*date*/ ctx[1]));
    			attr(path, "data-value", /*value*/ ctx[3]);

    			attr(path, "style", path_style_value = /*data*/ ctx[6] && /*data*/ ctx[6].hover
    			? "cursor: pointer;"
    			: false);
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*date*/ 2 && path_data_date_value !== (path_data_date_value = stringifyDate(/*date*/ ctx[1]))) {
    				attr(path, "data-date", path_data_date_value);
    			}
    			...
    			if (dirty & /*data*/ 64 && path_style_value !== (path_style_value = /*data*/ ctx[6] && /*data*/ ctx[6].hover
    			? "cursor: pointer;"
    			: false)) {
    ...
    /* src/views/Month.svelte generated by Svelte v3.29.0 */
    ...
    /* src/views/Week.svelte generated by Svelte v3.29.0 */
    ...
    /* src/SvelteHeatmap.svelte generated by Svelte v3.29.0 */
